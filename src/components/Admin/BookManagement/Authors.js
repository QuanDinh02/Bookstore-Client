                            ...
                            <table className="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <td className='table-head'>
                                            <span className='d-flex justify-content-between'>Author Name <BsArrowDownUp className='filter-icon' /></span>
                                        </td>
                                        <td className='table-head'>
                                ...
                                <tbody>
                                    {
                                        [...Array(5)].map(item => {
                                            return (
                                                <tr>
                                                    <td>1</td>
                                                    <td className='text-center author-img'><img src={User}></img></td>
